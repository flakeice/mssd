...
cfg.MODEL.TRACK_HEAD.SEARCH_REGION = 4.0
# the minimal width / height of the search region
cfg.MODEL.TRACK_HEAD.MINIMUM_SREACH_REGION = 0
cfg.MODEL.TRACK_HEAD.MODEL = 'EMM'

# solver params
cfg.MODEL.TRACK_HEAD.TRACK_THRESH = 0.2
cfg.MODEL.TRACK_HEAD.START_TRACK_THRESH = 0.3
cfg.MODEL.TRACK_HEAD.RESUME_TRACK_THRESH = 0.3
...
cfg.MODEL.TRACK_HEAD.EMM.COSINE_WINDOW_WEIGHT = 0.1
